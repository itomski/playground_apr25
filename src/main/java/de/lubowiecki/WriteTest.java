...
public class WriteTest {
    ...
    public static void main(String[] args) {
        ...
        if(file.exists()) {
            ...
            try {
                // Wenn appand-Mode false ist, wird der Inhalt IMMER überschrieben
                Writer out = new FileWriter(file, true); // FileWriter schreibt
                //out.write(65); // Schreibt ein Zeichen
                out.write(str); // Schreibt einen String
